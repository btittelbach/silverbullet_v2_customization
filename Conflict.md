---
title: Conflicts Resolver Script v2
tags: meta
---

To make this work safely, configure your silverbullet daemon with `SB_SHELL_WHITELIST="diff"`


## Widget

```space-lua
-- Initialize widget table if it doesn't already exist
widgets = widgets or {}
